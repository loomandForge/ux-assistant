...
export const resolveReviewInput = (request) => {
    if (request.figmaUrl) {
    ...
    if (!context) {
        throw new Error('No review input provided. Pass figmaUrl, webUrl, imagePath, htmlSnippet, or chatContext for auto-detect.');
    }
    ...
    throw new Error('Auto-detect did not find a Figma URL, web URL, or valid image path in chatContext.');
};

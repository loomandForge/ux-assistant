...
export const parseDesignSystemMode = (value: string | undefined): DesignSystemMode => {
  if (!value) {
    return 'generic';
  }
 ...
 */
export const loadDesignSystemConfig = (): DesignSystemConfig => {
  ...
  const enableExternalMcp =
    process.env.UX_REVIEW_DESIGN_SYSTEM_MCP_ENABLED === 'true' ||

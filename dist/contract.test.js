...
import { addContextRuleInputSchema, compareValidationRunsInputSchema, createContextPackInputSchema, createProjectInputSchema, generateCorrectionPromptInputSchema, validateOutputAgainstContextInputSchema, validationFindingSchema } from './contract.js';
...
test('validationFindingSchema accepts expected statuses', () => {
    const finding = validationFindingSchema.parse({
        ...
        correctionPrompt: 'Revise hero so only Enquire Now is primary. Convert others to secondary links.'
    });

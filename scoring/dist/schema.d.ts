export type ReviewParameterKey = 'user_flow_interaction' | 'visual_hierarchy_layout' | 'design_system_consistency' | 'accessibility_wcag' | 'content_information_architecture' | 'technical_feasibility' | 'brand_design_quality';

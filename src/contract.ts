...
export type ValidateOutputAgainstContextInput = z.infer<
  typeof validateOutputAgainstContextInputSchema
>;
...
export const validateStrategicArtifacts = (value: unknown): StrategicArtifactsContract => {
